...
class M_tarif extends CI_Model
{
    ...
    private $order = ['m.id', 'm.kode_tarif', 'm.nama', 'm.kategori', 'tj.kode_cabang', 'tj.jasa_rs', 'tj.jasa_dokter', 'tj.jasa_pelayanan', 'tj.jasa_poli'];
    private $kolom = ['m.id', 'm.kode_tarif', 'm.nama', 'm.kategori', 'tj.kode_cabang', 'tj.jasa_rs', 'tj.jasa_dokter', 'tj.jasa_pelayanan', 'tj.jasa_poli'];
    private $search = ['m.id', 'm.kode_tarif', 'm.nama', 'tj.jasa_rs', 'tj.jasa_dokter', 'tj.jasa_pelayanan', 'tj.jasa_poli'];
