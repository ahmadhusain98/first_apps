                                        ...
                                        foreach ($query_master as $qm) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <button type="button" title="Pulihkan" class="btn btn-success" onclick="pulihkan_one('<?= $qm->id ?>', '<?= $qm->nama ?>', '<?= $qm->tabel ?>')"><i class="fa fa-trash-restore-alt"></i></button>
                                                    <button type="button" title="Hapus" class="btn btn-dark" onclick="hapus_one('<?= $qm->id ?>', '<?= $qm->nama ?>', '<?= $qm->tabel ?>')"><i class="fa fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        <?php $no++;
                                        endforeach; ?>
