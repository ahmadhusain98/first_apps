        ...
        <form method="post" id="form_dokter">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title"><b># Form Dokter</b></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-danger btn-sm" onclick="getUrl('Master/dokter')" id="btnKembali"><ion-icon name="play-back-outline"></ion-icon> Kembali</button>
                            <button type="button" class="btn btn-dark float-right btn-sm ml-2" onclick="save()" id="btnSimpan"><ion-icon name="save-outline"></ion-icon> <?= (!empty($data_dokter) ? 'Perbarui' : 'Simpan') ?></button>
                            <?php if (!empty($data_dokter)) : ?>
                                <button type="button" class="btn btn-success float-right btn-sm" onclick="getUrl('Master/form_dokter/0')" id="btnBaru"><ion-icon name="add-circle-outline"></ion-icon> Baru</button>
                            <?php else : ?>
