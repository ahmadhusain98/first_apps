...
<form method="post" id="form_ruang">
    <div class="row" data-aos="fade-down"
        ...
        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="kodeRuang" name="kodeRuang" placeholder="Otomatis" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <span class="font-weight-bold h4"><i class="fa-solid fa-bookmark text-primary"></i> Daftar Ruang</span>
                    <div class="float-right">
                        <button type="button" class="btn btn-info" onclick="send_data_mail('Master Ruang')"><i class="fa-solid fa-paper-plane"></i>&nbsp;&nbsp;Kirim Email</button>
                        <div class="btn-group">
                            <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa-solid fa-circle-down"></i>&nbsp;&nbsp;Unduh
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#" onclick="preview('ruang')"><i class="fa-solid fa-fw fa-tv"></i>&nbsp;&nbsp;Preview</a></li>
                                <li><a class="dropdown-item" href="#" onclick="print('ruang')"><i class="fa-regular fa-fw fa-file-pdf"></i>&nbsp;&nbsp;Pdf</a></li>
                                <li><a class="dropdown-item" href="#" onclick="excel('ruang')"><i class="fa-regular fa-fw fa-file-excel"></i>&nbsp;&nbsp;Excel</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-hover table-bordered" id="tableRuang" width="100%" style="border-radius: 10px;">
                                    <thead>
...
<script>
    ...
    function proses(param) {
        ...
        $.ajax({
            url: siteUrl + 'Master/ruang_proses/' + param,
            type: "POST",
            data: form.serialize(),
            dataType: "JSON",
            success: function(result) { // jika fungsi berjalan dengan baik
                ...
                if (result.status == 1) { // jika mendapatkan respon 1
                    ...
                    Swal.fire("Ruang", "Berhasil " + message, "success").then(() => {
                        reseting();
                        reloadTable();
                    });
                } else { // selain itu

                    Swal.fire("Ruang", "Gagal " + message + ", silahkan dicoba kembali", "info");
                }
            },
            error: function(result) { // jika fungsi error
                btnSimpan.attr('disabled', false);
    ...
    function ubah(kode_ruang) {
        // jalankan fungsi
        $.ajax({
            url: siteUrl + 'Master/getInfoRuang/' + kode_ruang,
            type: 'POST',
            dataType: 'JSON',
    ...
    function hapus(kode_ruang) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) { // jika yakin
                ...
                // jalankan fungsi
                $.ajax({
                    url: siteUrl + 'Master/delRuang/' + kode_ruang,
                    type: 'POST',
                    dataType: 'JSON',
                    success: function(result) { // jika fungsi berjalan dengan baik
                        btnSimpan.attr('disabled', false);
                        ...
                        if (result.status == 1) { // jika mendapatkan hasil 1
                            ...
                            Swal.fire("Ruang", "Berhasil di hapus!", "success").then(() => {
                                reloadTable();
                            });
                        } else { // selain itu

                            Swal.fire("Ruang", "Gagal di hapus!, silahkan dicoba kembali", "info");
                        }
                    },
                    error: function(result) { // jika fungsi error
                        btnSimpan.attr('disabled', false);
    ...
    function showGuide() {
        ...
        // isi text
        $('#modal_mgLabel').append(`Manual Guide Master Ruang`);
        $('#modal-isi').append(`
            <ol>
