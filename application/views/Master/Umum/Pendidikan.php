        ...
        <div class="col-md-12">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-info" onclick="send_data_mail('Master Pendidikan')"><i class="fa-solid fa-paper-plane"></i>&nbsp;&nbsp;Kirim Email</button>
                        <div class="btn-group">
...
<script>
    ...
    function showGuide() {
        ...
        // isi text
        $('#modal_mgLabel').append(`Manual Guide Master Pendidikan`);
        $('#modal-isi').append(`
            <ol>
