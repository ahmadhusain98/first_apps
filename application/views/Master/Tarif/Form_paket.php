            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="kodeTarif" class="control-label">Kode Tarif</label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="kategori" class="control-label">Kategori Tarif <sup class="text-danger">**</sup></label>
                                <div class="row">
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">
                                <label for="jenix">Jenis Tarif</label>
