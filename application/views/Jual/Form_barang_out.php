        ...
        <div class="col-md-12">
            <div class="card shadow">
                <div class="card-header">
                    <div class="h4 font-weight-bold"># Form Penjualan</div>
                </div>
                <div class="card-body">
                    <div class="card shadow">
                        <div class="card-header">
                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="h4"># Detail Barang Jual</div>
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="tableDetailBarangOut">
                                            <thead>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-dark float-right btn-sm ml-2" onclick="save()" id="btnSimpan"><ion-icon name="save-outline"></ion-icon> <?= (!empty($data_barang_out) ? 'Perbarui' : 'Simpan') ?></button>
                            <?php if (!empty($data_barang_out)) : ?>
                                <button type="button" class="btn btn-success float-right btn-sm" onclick="getUrl('Transaksi/form_barang_out/0')" id="btnBaru"><ion-icon name="add-circle-outline"></ion-icon> Baru</button>
                            <?php else : ?>
