    ...
    <div class="row">
        ...
        <div class="col-md-4 col-12">
            <div class="float-right">
                ...
                <button type="button" class="btn btn-success" onclick="getUrl('Transaksi/form_barang_in/0')" <?= (($created == 1) ? _lock_button() : 'disabled') ?>><i class="fa-solid fa-circle-plus"></i>&nbsp;&nbsp;Tambah</button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="tableBarangIn" width="100%" style="border-radius: 10px;">
                    <thead>
