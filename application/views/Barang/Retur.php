        ...
        <form method="post" id="form_barang_in_retur">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-sm float-right mb-1 btn-success ml-1" onclick="getUrl('Transaksi/form_barang_in_retur/0')" <?= (($created > 0) ? '' : 'disabled') ?>><ion-icon name="add-circle-outline"></ion-icon> Baru</button>
