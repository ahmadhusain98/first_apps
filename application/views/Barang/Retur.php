        ...
        <form method="post" id="form_barang_in_retur">
            <div class="card">
                <div class="card-header">
                    <span class="font-weight-bold h4"># Retur Pembelian</span>
                    <button type="button" class="btn btn-sm float-right mb-1 btn-success ml-1" onclick="getUrl('Transaksi/form_barang_in_retur/0')" <?= (($created > 0) ? _lock_button() : 'disabled') ?>><ion-icon name="add-circle-outline"></ion-icon> Baru</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="tableBarangInRetur" width="100%">
                                    <thead>
