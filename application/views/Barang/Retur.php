            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="float-right">
                        ...
                        <button type="button" class="btn btn-success" onclick="getUrl('Transaksi/form_barang_in_retur/0')" <?= (($created > 0) ? _lock_button() : 'disabled') ?>><i class="fa-solid fa-circle-plus"></i>&nbsp;&nbsp;Tambah</button>
                    </div>
                </div>
